<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <x-label>
                <x-input type="radio" name="schedule" value="monthly" :checked="old('schedule') == 'monthly'" />
        ...
        <div>
            ...
            <x-label>
                <x-input type="radio" name="schedule_onetime" value="none" :checked="old('schedule_onetime') == 'none'" />
